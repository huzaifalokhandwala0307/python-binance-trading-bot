...
A minimal, production-style Python trading bot that places **MARKET** and **LIMIT** orders on the [Binance Futures Testnet (USDT-M)](https://testnet.binancefuture.com) via a clean CLI interface.
